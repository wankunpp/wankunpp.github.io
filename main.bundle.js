...
module.exports = ".bg-overlay-3{\n    background: url('bg-banner03.d0e0f565892be726616a.jpg') fixed;\n    background-size:cover;\n    position: relative;\n    min-height:500px;\n    \n}\n\n\n.overlay{\n    background-color: rgba(0,0,0,0.67);\n    min-height:500px;\n}\n\n\n.wrapper-message{\n    color: white;\n    position: absolute;\n    left: 0;\n    top: 40%;\n    width: 100%;\n    text-align: center;\n    font-size: 50px;\n}\n\n\nsection {\n\tposition: relative;\n}\n\n\n.service-content{\n   margin-top:100px;\n   margin-bottom: 100px;\n    \n}\n\n\n.single-service-makeup{\n    margin:0 40px;\n    background: url('port01.bbb29596da50b6253167.jpg') fixed;\n    background-size:cover;\n    position: relative;\n    min-height:300px;\n    width:300px;\n}\n"
...
module.exports = "<section class=\"bg-overlay-3\">\n    <div class=\"overlay\">\n        <div class=\"row justify-content-md-center\">\n            <div class=\"wrapper-message\">\n                <h1>Services</h1>\n            </div>\n        </div>\n    </div>\n</section>\n\n<div class=\"container service-content\">\n    <div class=\"row\">\n        <div class=\"single-service-makeup\">\n                <div class=\"wrapper-message\">\n                       <a routerLink=\"/makeup\" style=\"color:white;\"> <h2>Makeup</h2></a>\n                </div>\n        </div>\n        <div class=\" single-service-makeup\">\n                <div class=\"wrapper-message\">\n                        <a routerLink=\"/cosmetics\" style=\"color:white; \"> <h2>Cosmetics</h2></a>\n                </div>\n        </div>\n        <div class=\"single-service-makeup\">\n                <div class=\"wrapper-message\">\n                        <a routerLink=\"/cakes\" style=\"color:white;\"> <h2>Cakes</h2></a>\n                </div>\n        </div>\n    </div>\n</div>"
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.updateItem = function (item, amount) {
        var newItem = new __WEBPACK_IMPORTED_MODULE_1__item_model__["a" /* Item */](item.name, item.description, item.imgUrl, item.price, amount);
        var index = this.cart.indexOf(item);
        this.cart[index] = newItem;
        this.cartChanged.next(this.cart.slice());
    };
    CartService.prototype.getItembyName = function (name) {
        return this.cart.find(function (item) { return item.name === name; });
    };
    return CartService;
}());
...
var ShoppingCartComponent = /** @class */ (function () {
    ...
    ShoppingCartComponent.prototype.onChangeAmount = function (name) {
        var getitembyname = this.cartService.getItembyName(name);
